...
export const STANDARD_PERMISSIONS = [
  ...
  {
    permissionName: "Correct Attendance",
    permissionCode: "attendance.correct",
    module: "ATTENDANCE",
    description: "Adjust or correct employee check-in/out timestamps and status",
  },
  {
    permissionName: "Delete Attendance",
    permissionCode: "attendance.delete",
    module: "ATTENDANCE",
